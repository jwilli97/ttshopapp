...
const TinyTokenShop: React.FC = () => {
    ...
    return (
        <div className="w-96">
            <div>
                <p className="mb-0.5">Tiny Token Balance</p>
            </div>
            <div className="flex flex-row align-left items-center mb-2">
                <CoinIcon />
                <p className="ml-1">0</p> {/* set to user's token balance from DB, delete comment when complete */}
            </div>
            <Progress value={33} className="h-3 mb-0.5" /> {/* set progress bar to show user's token balance from DB, delete comment when complete */}
            ...
            <div className="mt-2">
                <div className="flex flex-row align-left items-center">
                    ...
                    <p className="hover:font-bold cursor-pointer ml-1" onClick={toggleShop}>Tiny Token Shop</p>
                </div>
                {showShop && (
