...
export default function CreateAccount() {
  ...
  return (
    <div className="flex h-screen w-full flex-col items-center justify-center px-4 py-12">
      ...
      <Button size="lg" className="bg-primary hover:bg-primary/75 w-72 h-11" onClick={() => router.push('/createAccount/New')}>I%apos;m a new customer</Button>
      <Button size="lg" className="bg-primary hover:bg-primary/75 w-72 h-11 mt-6" onClick={() => router.push('/createAccount/Returning')}>I%apos;ve shopped here before</Button>
